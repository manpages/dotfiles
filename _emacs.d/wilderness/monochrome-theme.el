...
(let ((class '((class color) (min-colors 10)))
  ...
  (custom-theme-set-faces
   ...
   `(isearch ((,class (:foreground ,black :background ,dgray))))
   `(lazy-highlight ((,class (:foreground ,black :background ,dgray))))
   ...
   `(font-lock-function-name-face ((,class (:foreground ,dgray))))
   `(font-lock-keyword-face ((,class (:foreground ,dgray))))
   `(font-lock-string-face ((,class (:foreground ,lgray))))
   `(font-lock-type-face ((,class (:foreground ,dgray))))
  ...
  (custom-theme-set-variables
   'monochrome
   `(ansi-color-names-vector [,black ,lgray ,dgray ,sgray ,fifty ,vgray])))
